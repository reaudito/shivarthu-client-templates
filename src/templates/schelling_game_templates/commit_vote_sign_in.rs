...
#[component]
pub fn SignTransaction(hash: [u8; 32], {{params_variable}}: {{params_variable_type}}) -> impl IntoView {
    view! { <ExtensionSignIn hash=hash {{params_variable}}={{params_variable}}/> }
}

#[component]
pub fn ExtensionSignIn(hash: [u8; 32], {{params_variable}}: {{params_variable_type}}) -> impl IntoView {
